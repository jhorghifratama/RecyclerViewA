...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        nm = new NegaraModel();
        nm.setNama("Slovenia");
        nm.setDeskripsi("Slovenia adalah negara maju, dengan ekonomi berpenghasilan tinggi yang maju; berperingkat sangat tinggi dalam Indeks Pembangunan Manusia");
        nm.setUrl("https://icons.iconarchive.com/icons/custom-icon-design/all-country-flag/256/Slovenia-Flag-icon.png");
        negaraModelList.add(nm);

        nm = new NegaraModel();
        nm.setNama("Belgium");
        nm.setDeskripsi("Namanya belgia dalam bahasa Indonesia. Belgia adalah sebuah negara di Eropa bagian barat.");
